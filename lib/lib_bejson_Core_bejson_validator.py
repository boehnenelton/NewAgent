...
RELATIONAL_ID:  86f3c0a1-cadd-4865-887d-fc6e4c20dfd5
"""
...
class ValidationResult:
    ...
    def is_valid(self) -> bool:
        ...
        API -- no caller in this codebase used it as of pkg69, but nothing
        stops a caller elsewhere (e.g. a PROFILER-style tool not shipped in
        this package) from doing so and crashing with AttributeError. Cheap
        to make both spellings work rather than requiring every consumer,
        present or future, to know the exact attribute name."""
        return self.valid
